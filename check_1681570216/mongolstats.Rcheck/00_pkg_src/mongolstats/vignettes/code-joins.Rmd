...
- Prefer ISO-like stable keys (e.g., `shapeISO`) over names when available.
- Keep your crosswalks in version control (e.g., `inst/extdata/…`) and document their provenance.
- Validate joins by checking for unmatched rows and duplicates in the key.
