...
```{r time-series-plot, fig.height=6}
...
```{r monthly-boxplot, fig.height=6}
...
```{r monthly-means-plot, fig.height=5}
...
```{r stl-decomposition, fig.height=8}
...
```{r cause-trends-plot, fig.height=6}
p <- cause_deaths |>
  filter(year >= 2015) |>
...
```{r respiratory-proxy, fig.height=5}
...
```{r urban-rural-comparison, fig.height=6}
...
```{r hospital-comparison, fig.height=6}
