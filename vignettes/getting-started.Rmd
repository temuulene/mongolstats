...
```{r plot-trend, fig.alt="Line plot showing the trend in Mongolia's monthly infant mortality rate from 2015 to 2024, with a LOESS smoother highlighting the overall direction"}
...
p <- imr_national |>
  ...
  # LOESS reveals trend through monthly noise
  geom_smooth(
    method = "loess", se = TRUE, color = "#3498db", fill = "#3498db",
